...
<div class="container-fluid px-4 py-3">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Edit Image for Product #{{ $product->product_id }}</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.product_images.update', [$product->product_id, $image->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
