...
<div class="container-fluid px-4 py-3">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Add New Image to Service: {{ $service->service_name }}</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.services.service_images.store', $service->service_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
