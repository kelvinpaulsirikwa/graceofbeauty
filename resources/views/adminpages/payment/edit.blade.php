...
<div class="container-fluid px-4 py-3">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.payments.update', $payment->payment_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    @if($payment->image)
                        <div class="mb-2">
                            ...
                            <img src="{{ Storage::url($payment->image) }}" alt="{{ $payment->name }}" style="max-width: 200px; max-height: 200px; border-radius: 8px; border: 1px solid #ddd;">
                        </div>
                    @endif
                    <input 
                        type="file" 
